...
#' @param output_directory Full directory path for the output rasters (not a file path). Does not need to already be created
#' @param n_cores If desired, set the number of cores to use (defaults to 40% of total cores)
#' @param tile_size_adjustment If desired, adjust tile sizing. Set this to less than 1 to create smaller tiles less prone to failure in processing
#' @return Raster file of all desired attributes
#' @export
#'
#'
